...
import QuizPickOneInThree from '../component/QuizPickOneInThree'
...
const QuizTripleComponent: React.FC = () => {

  const [activeBtnIndex, setActiveBtnIndex] = useState(0);
  const [quizIndex, setQuizIndex] = useState(3);
      ...
      <div className="header">
        <div className="wrapper">
          ...
          <div>
            ...
            <p>
              {quizIndex === 1 ? "표정 고르기" : quizIndex === 2 ? "표정 짓기" : "표정 찾기"}
            </p>
          </div>
        </div>
      </div>
      <div className="body">
        <QuizPickOneInThree quizIndex={quizIndex} setQuizIndex={setQuizIndex} isSelected={isSelected} setIsSelected={setIsSelected}
        correctAnswer={correctAnswer} setCorrectAnswer={setCorrectAnswer} activeBtnIndex={activeBtnIndex} setActiveBtnIndex={setActiveBtnIndex}></QuizPickOneInThree>
      </div>
...
export default QuizTripleComponent;
